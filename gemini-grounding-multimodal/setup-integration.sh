...
# Export with: 
# integrationcli integrations scaffold -n gemini-multimodal -s 12 -e dev --cloud-build --cloud-deploy
# integrationcli integrations scaffold -n gemini-multimodal -s 12 -e dev --cloud-build --cloud-deploy --skip-connectors
